...
from viajeros.forms import LugarFormulario, VerLugarFormulario, UserRegisterForm
from viajeros.forms import  UserRegisterForm, UserUpdateForm, AvatarFormulario
from django.contrib.auth.mixins import LoginRequiredMixin

from viajeros.models import AboutMe, Lugares, Usuarios, Avatar


def inicio(request):
    return render(
        request=request,
        template_name='viajeros/inicioII.html')
...
def listar_lugares(request):
    ...
    return render(
        request=request,
        template_name='viajeros/formulario_lugares.html',
        context=contexto,
    )
...
def ver_lugar(request, id):
    ...
    return render(
        request=request,
        template_name='estudiantes/detalle_lugar.html',
        context=contexto,
    )
